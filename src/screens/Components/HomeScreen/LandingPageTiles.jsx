...
<div class="relative group overflow-hidden flex-auto rounded-lg col-span-2 lg:col-span-4">
...
<div class="relative group overflow-hidden flex-auto rounded-lg col-span-2">
  ...
  <div class="absolute bottom-4 left-4 text-white">
    ...
    <button class="mt-4 px-4 py-2 border-2 border-white hover:bg-white hover:text-black transition rounded">Coming Soon - Release 2.0</button>
  </div>
</div>
