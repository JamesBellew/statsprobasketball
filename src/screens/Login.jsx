    ...
    <>
      {showLoginModal && (
        ...
        >
          ...
          >
            <h2 className="text-xl font-bold text-gray-700 mb-4">Version 1.85 (12/06/2025)</h2>
...
<p className="font-bold text-primary-danger text-sm">10/06/2025 - Version 1.85</p>
