...
<li className="py-2">In the livegame home dashboard, it now shows the groupd of which each game was for again like seior mens 2025</li>
<li className="py-2">Major UI changes to accomidate the new label for the groups</li>
<li className="py-2">Cenetered a out of line player in the ingame lineout section</li>
...
<p className="font-bold text-primary-danger text-sm">24/06/2025 - Version 1.99</p>
<li className="py-2">Substitution timeline now added to livegameview</li>
<p className="font-bold text-primary-danger text-sm">23/06/2025 - Version 1.98</p>
<li className="py-2">Livegameview now has a a court map for the home team🔥</li>
...
<li className="py-2">League table created ane now in livegameview</li>
<li className="py-2">Livegameview now has a new design</li>
<li className="py-2">Improved UX/UI for livegameview</li>
<li className="py-2">Improved color pallet for away team colors</li>
<li className="py-2">Livegameview now has a new design</li>
...
<li className="py-2">Improved UX/UI for livegameview</li>
<li className="py-2">Improved color pallet for away team colors</li>
<p className="font-bold text-primary-danger text-sm">20/06/2025 - Version 1.95</p>
<li className="py-2">Livegameview now has a new design</li>
<li className="py-2">Livegameview now has a new design</li>
<li className="py-2">Improved UX/UI for livegameview</li>
<li className="py-2">Improved color pallet for away team colors</li>
<p className="font-bold text-primary-danger text-sm">19/06/2025 - Version 1.94</p>
<li className="py-2">Livegameview now has a new design</li>
<li className="py-2">Livegameview now has a new design</li>
<li className="py-2">Improved UX/UI for livegameview</li>
<li className="py-2">Improved color pallet for away team colors</li>
<p className="font-bold text-primary-danger text-sm">19/06/2025 - Version 1.93</p>
<li className="py-2">Away team color now saved to database</li>
<li className="py-2">Away team color now displayed in livegameview</li>
<li className="py-2">Away team color now displayed in ingame</li>
<li className="py-2">Away team color now displayed in homedashboard</li>
<li className="py-2">Away team color now displayed in scoreboard</li>
<p className="font-bold text-primary-danger text-sm">13/06/2025 - Version 1.92</p>
<li className="py-2">Livegamevview stats section now displays the away teams stats </li>
<li className="py-2">Ingame, you ca now track away teams stats</li>
<p className="font-bold text-primary-danger text-sm">13/06/2025 - Version 1.91</p>
<li className="py-2">Broadcast update now responsive to mobile</li>
<li className="py-2">Handling the display for when their is no lineout passed to the </li>
