...
<div class="grid grid-rows-7  h-full pt-4 pb-24 grid-cols-12 gap-4">
  <div class="row-span-3 rounded-md col-span-7 bg-secondary-bg text-white text-center flex items-center justify-center ...">Player Stats</div>
  <div class="row-span-2 rounded-md col-span-5 bg-secondary-bg  text-white text-center flex items-center justify-center ...">Game Stats</div>

  <div class="row-span-1 rounded-md col-span-5 bg-secondary-bg text-white text-center flex items-center justify-center ...">Steals-T/O</div>

  <div class="row-span-4 rounded-md col-span-12 bg-secondary-bg  text-white text-center flex items-center justify-center ...">Heat Map</div>
...
<div class="fixed z-50 w-full h-16 max-w-lg -translate-x-1/2  border border-gray-800 rounded-full bottom-4 left-1/2
 bg-secondary-bg">
    <div class="grid h-full max-w-lg grid-cols-5 mx-auto">
        <button data-tooltip-target="tooltip-home" type="button" class="inline-flex flex-col items-center justify-center px-5 rounded-s-full hover:bg-gray-50 dark:hover:bg-white/10 group">
        ...
        <button data-tooltip-target="tooltip-wallet" type="button" class="inline-flex flex-col items-center justify-center px-5 hover:bg-gray-50 dark:hover:bg-white/10 group">
            <svg class="w-5 h-5 mb-1  dark:text-gray-400 group-hover:text-primary-cta dark:group-hover:text-primary-cta" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 20 20">
